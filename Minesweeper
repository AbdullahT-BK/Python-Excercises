...
# lets create a board object to represent the minesweeper gamer
# this is so that we can just say "create a new board object" or 
# "dig here", or "render this game for this object"
class Board:
    def __init__(self, dim_size, num_bombs):
        # let's keep track of these parameteres. they'll be helpful later
    ...
    #intialize a set to keep track of which locations we've uncovered
